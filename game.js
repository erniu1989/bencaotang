...
{id:151,name:"细辛",emoji:"\u{1F33F}",cat:"解表药",nature:"温",flavor:"辛",meridian:"心、肺、肾",effect:"解表散寒、祛风止痛、通窍、温肺化饮",indication:"风寒感冒、头痛牙痛、鼻塞鼻渊、风湿痹痛、寒饮咳喘",formula:"独活寄生汤",fun:"细辛气味辛烈，具有一定毒性，传统应用强调规范品种、剂量和煎煮时间，不可自行大量使用。"},
{id:152,name:"白前",emoji:"\u{1F33F}",cat:"化痰药",nature:"微温",flavor:"辛、苦",meridian:"肺",effect:"降气、消痰、止咳",indication:"肺气壅实、咳嗽痰多、气逆喘促、新久咳嗽",formula:"止嗽散",fun:"白前善于降肺气、消痰止咳，无论寒热咳嗽均可根据辨证配伍使用。"},
{id:153,name:"粳米",emoji:"\u{1F35A}",cat:"补益药",nature:"平",flavor:"甘",meridian:"脾、胃、肺",effect:"补中益气、健脾和胃、除烦止渴",indication:"脾胃虚弱、食少体倦、热病烦渴、胃气不和",formula:"白虎汤",fun:"粳米既是日常粮食，也常作为方剂配伍药物，可顾护胃气并调和药性。"},
{id:154,name:"鳖甲",emoji:"\u{1F422}",cat:"补益药",nature:"微寒",flavor:"咸",meridian:"肝、肾",effect:"滋阴潜阳、退热除蒸、软坚散结",indication:"阴虚发热、骨蒸劳热、阴虚阳亢、久疟疟母、癥瘕积聚",formula:"青蒿鳖甲汤",fun:"鳖甲为鳖的背甲，入汤剂通常需要先煎；其来源涉及动物药材，应注意合法、规范使用。"},
{id:155,name:"侧柏叶",emoji:"\u{1F343}",cat:"止血药",nature:"寒",flavor:"苦、涩",meridian:"肺、肝、脾",effect:"凉血止血、化痰止咳、生发乌发",indication:"血热吐血、衄血、咯血、便血、崩漏、肺热咳嗽、血热脱发",formula:"槐花散",fun:"侧柏叶来自侧柏的枝梢和叶，既能凉血止血，也有化痰止咳的传统应用。"},
{id:156,name:"蒲黄",emoji:"\u{1F7E1}",cat:"止血药",nature:"平",flavor:"甘",meridian:"肝、心包",effect:"止血、化瘀、通淋",indication:"吐血衄血、咯血、崩漏、外伤出血、经闭痛经、胸腹刺痛、血淋涩痛",formula:"小蓟饮子",fun:"蒲黄是香蒲的干燥花粉，颗粒细小，传统煎煮时通常需要包煎；生用偏化瘀，炒用偏止血。"},
{id:157,name:"淡竹叶",emoji:"\u{1F38B}",cat:"清热药",nature:"寒",flavor:"甘、淡",meridian:"心、胃、小肠",effect:"清热泻火、除烦止渴、利尿通淋",indication:"热病烦渴、口舌生疮、心火亢盛、小便短赤涩痛",formula:"小蓟饮子",fun:"淡竹叶与竹叶名称相近，但植物来源和药用部位并不完全相同，数据库中应作为两味药分别收录。"},
{id:158,name:"藕节",emoji:"\u{1FAB7}",cat:"止血药",nature:"平",flavor:"甘、涩",meridian:"肝、肺、胃",effect:"收敛止血、化瘀",indication:"吐血、衄血、咯血、尿血、便血、崩漏等多种出血证",formula:"小蓟饮子",fun:"藕节是莲的根茎节部，药性较为平和，传统上常用于多种出血证。"},
{id:159,name:"槟榔",emoji:"\u{1FAD8}",cat:"驱虫药",nature:"温",flavor:"苦、辛",meridian:"胃、大肠",effect:"杀虫消积、行气、利水、截疟",indication:"绦虫蛔虫、姜片虫病、虫积腹痛、食积气滞、泻痢后重、水肿脚气、疟疾",formula:"芍药汤",fun:"槟榔具有杀虫和行气作用，但长期咀嚼槟榔会显著增加口腔健康风险，不应把药用与日常咀嚼混为一谈。"},
{id:160,name:"白扁豆",emoji:"\u{1FAD8}",cat:"补益药",nature:"微温",flavor:"甘",meridian:"脾、胃",effect:"健脾化湿、和中消暑",indication:"脾胃虚弱、食欲不振、大便溏泻、白带过多、暑湿吐泻、胸闷腹胀",formula:"参苓白术散",fun:"白扁豆属于药食两用材料，偏于健脾化湿；生品含有不宜直接食用的成分，需要充分加热。"},
{id:161,name:"莲子",emoji:"\u{1FAD8}",cat:"收涩药",nature:"平",flavor:"甘、涩",meridian:"脾、肾、心",effect:"补脾止泻、益肾固精、止带、养心安神",indication:"脾虚久泻、食欲不振、肾虚遗精、滑精、带下、心悸失眠",formula:"参苓白术散",fun:"莲子是莲的成熟种子，既能补脾益肾，又能养心安神；莲子心则功效和药性有所不同。"},
{id:162,name:"通草",emoji:"\u{1F33F}",cat:"祛湿药",nature:"微寒",flavor:"甘、淡",meridian:"肺、胃",effect:"清热利尿、通气下乳",indication:"湿热淋证、小便短赤、水肿尿少、产后乳汁不下、乳汁稀少",formula:"三仁汤",fun:"通草来源于植物茎髓，质地轻软洁白，使用时应注意与木通等名称相近的药材区分。"},
{id:163,name:"炙甘草",emoji:"\u{1F33F}",cat:"补益药",nature:"温",flavor:"甘",meridian:"心、肺、脾、胃",effect:"补脾和胃、益气复脉",indication:"脾胃虚弱、倦怠乏力、心气不足、心悸、脉结代",formula:"炙甘草汤",fun:"炙甘草通常由甘草经过蜜炙制成，与生甘草相比更偏于补益脾胃、益气复脉。"},
{id:164,name:"柿蒂",emoji:"\u{1F34A}",cat:"理气药",nature:"平",flavor:"苦、涩",meridian:"胃",effect:"降气止呃",indication:"胃气上逆、呃逆不止，以及寒热不同证型的呃逆",formula:"丁香柿蒂汤",fun:"柿蒂是柿果顶部宿存的花萼，形如小帽，传统上专长于降胃气、止呃逆。"},
{id:165,name:"鹿茸",emoji:"\u{1F98C}",cat:"补益药",nature:"温",flavor:"甘、咸",meridian:"肾、肝",effect:"壮肾阳、益精血、强筋骨、调冲任、托疮毒",indication:"肾阳不足、精血亏虚、畏寒肢冷、腰膝酸软、阳痿早泄、宫冷不孕、崩漏带下",formula:"右归丸",fun:"鹿茸是雄鹿尚未骨化且带茸毛的幼角，属于动物药材，应注意合法来源和规范使用。"},
{id:166,name:"淫羊藿",emoji:"\u{1F343}",cat:"补益药",nature:"温",flavor:"辛、甘",meridian:"肝、肾",effect:"补肾阳、强筋骨、祛风湿",indication:"肾阳虚衰、阳痿遗精、筋骨痿软、风寒湿痹、肢体麻木拘挛",formula:"仙灵脾散",fun:"淫羊藿又称仙灵脾，是常用的补肾阳药，同时能够祛风湿、强筋骨。"},
{id:167,name:"巴戟天",emoji:"\u{1F33F}",cat:"补益药",nature:"微温",flavor:"辛、甘",meridian:"肾、肝",effect:"补肾阳、强筋骨、祛风湿",indication:"肾阳虚弱、阳痿遗精、宫冷不孕、月经不调、少腹冷痛、风湿痹痛、筋骨痿软",formula:"巴戟丸",fun:"巴戟天以根入药，常与淫羊藿、杜仲等配伍，用于肾阳不足兼筋骨不健之证。"},
{id:168,name:"补骨脂",emoji:"\u{1F331}",cat:"补益药",nature:"温",flavor:"辛、苦",meridian:"肾、脾",effect:"补肾壮阳、固精缩尿、温脾止泻、纳气平喘",indication:"肾阳不足、阳痿遗精、遗尿尿频、腰膝冷痛、五更泄泻、肾不纳气之虚喘",formula:"四神丸",fun:"补骨脂又称破故纸，既能温补肾阳，也可温脾止泻；传统应用强调辨证，不宜自行长期服用。"},
{id:169,name:"菟丝子",emoji:"\u{1F33E}",cat:"补益药",nature:"平",flavor:"辛、甘",meridian:"肝、肾、脾",effect:"补益肝肾、固精缩尿、安胎、明目、止泻",indication:"腰膝酸软、阳痿遗精、遗尿尿频、肝肾不足之目暗、胎动不安、脾肾虚泻",formula:"五子衍宗丸",fun:"菟丝子来源于寄生植物的成熟种子，药性较为平和，兼能补肾、益肝和健脾。"},
{id:170,name:"制何首乌",emoji:"\u{1F33F}",cat:"补益药",nature:"微温",flavor:"甘、涩",meridian:"肝、肾",effect:"补肝肾、益精血、乌须发、强筋骨、化浊降脂",indication:"血虚萎黄、眩晕耳鸣、须发早白、腰膝酸软、肢体麻木、高脂血症",formula:"七宝美髯丹",fun:"制何首乌与生何首乌功效不同；何首乌类药物可能引起肝损伤，必须规范炮制并在专业指导下使用。"},
{id:171,name:"女贞子",emoji:"\u{1FAD0}",cat:"补益药",nature:"凉",flavor:"甘、苦",meridian:"肝、肾",effect:"滋补肝肾、明目乌发",indication:"肝肾阴虚、眩晕耳鸣、腰膝酸软、须发早白、目暗不明、内热消渴",formula:"二至丸",fun:"女贞子是女贞树的成熟果实，冬季果实呈紫黑色，常与墨旱莲配伍组成二至丸。"},
{id:172,name:"墨旱莲",emoji:"\u{1F33F}",cat:"补益药",nature:"寒",flavor:"甘、酸",meridian:"肾、肝",effect:"滋补肝肾、凉血止血",indication:"肝肾阴虚、牙齿松动、须发早白、眩晕耳鸣、阴虚血热之吐血衄血、尿血、便血、崩漏",formula:"二至丸",fun:"墨旱莲茎叶揉搓后可见深色汁液，传统上常与女贞子配伍以滋补肝肾。"},
{id:173,name:"北沙参",emoji:"\u{1F33F}",cat:"补益药",nature:"微寒",flavor:"甘、微苦",meridian:"肺、胃",effect:"养阴清肺、益胃生津",indication:"肺热燥咳、阴虚劳嗽、干咳少痰、胃阴不足、津伤口渴",formula:"沙参麦冬汤",fun:"北沙参与南沙参名称相近但植物来源不同，北沙参更偏于养阴生津，使用时应注意区分。"},
{id:174,name:"百合",emoji:"\u{1F33A}",cat:"补益药",nature:"微寒",flavor:"甘",meridian:"心、肺",effect:"养阴润肺、清心安神",indication:"阴虚燥咳、劳嗽咳血、虚烦惊悸、失眠多梦、精神恍惚",formula:"百合固金汤",fun:"百合的鳞茎可以入药，也是常见食材，因鳞片层层相合而得名。"},
{id:175,name:"玉竹",emoji:"\u{1F38B}",cat:"补益药",nature:"微寒",flavor:"甘",meridian:"肺、胃",effect:"养阴润燥、生津止渴",indication:"肺阴不足、燥热咳嗽、咽干口渴、胃阴不足、内热消渴",formula:"益胃汤",fun:"玉竹茎节形似竹节，以根茎入药，养阴而不甚滋腻，是常用的药食两用材料。"},
{id:176,name:"南沙参",emoji:"\u{1F33F}",cat:"补益药",nature:"微寒",flavor:"甘",meridian:"肺、胃",effect:"养阴清肺、益胃生津、化痰、益气",indication:"肺热燥咳、阴虚劳嗽、干咳痰黏、胃阴不足、津伤口渴、气阴两伤",formula:"沙参麦冬汤",fun:"南沙参与北沙参名称相近但来源不同，南沙参除养阴生津外，兼有一定化痰益气作用。"},
{id:177,name:"黄精",emoji:"\u{1F33F}",cat:"补益药",nature:"平",flavor:"甘",meridian:"脾、肺、肾",effect:"补气养阴、健脾、润肺、益肾",indication:"脾胃气虚、体倦乏力、胃阴不足、口干食少、肺虚燥咳、精血不足、腰膝酸软",formula:"黄精丸",fun:"黄精是一种药食两用材料，传统炮制常采用蒸制方法；未经规范炮制的黄精可能刺激咽喉。"},
{id:178,name:"桑椹",emoji:"\u{1FAD0}",cat:"补益药",nature:"寒",flavor:"甘、酸",meridian:"心、肝、肾",effect:"滋阴补血、生津润燥",indication:"肝肾阴虚、眩晕耳鸣、心悸失眠、须发早白、津伤口渴、内热消渴、肠燥便秘",formula:"桑椹膏",fun:"桑椹是桑树的成熟果实，既可入药又可食用，成熟时常呈紫黑色，汁液容易染色。"},
{id:179,name:"黑芝麻",emoji:"\u{1F331}",cat:"补益药",nature:"平",flavor:"甘",meridian:"肝、肾、大肠",effect:"补益精血、润燥滑肠",indication:"精血亏虚、头晕眼花、耳鸣耳聋、须发早白、病后脱发、肠燥便秘",formula:"桑麻丸",fun:"黑芝麻是常见的药食两用材料，富含油脂，传统上利用其甘润特点补益精血、润肠通便。"},
{id:180,name:"龟甲",emoji:"\u{1F422}",cat:"补益药",nature:"微寒",flavor:"咸、甘",meridian:"肝、肾、心",effect:"滋阴潜阳、益肾强骨、养血补心、固经止崩",indication:"阴虚潮热、骨蒸盗汗、头晕目眩、筋骨痿软、小儿囟门不合、心虚健忘、崩漏经多",formula:"大补阴丸",fun:"龟甲是龟的背甲及腹甲，质地坚硬，传统汤剂中通常打碎先煎；动物药材应注意合法来源与规范使用。"},
{id:181,name:"太子参",emoji:"\u{1F33F}",cat:"补益药",nature:"平",flavor:"甘、微苦",meridian:"脾、肺",effect:"益气健脾、生津润肺",indication:"脾虚体倦、食欲不振、病后虚弱、气阴不足、自汗口渴、肺燥干咳",formula:"太子参汤",fun:"太子参补气作用较为平和，又能生津，传统上常用于气阴不足或病后体虚者。"},
{id:182,name:"西洋参",emoji:"\u{1F331}",cat:"补益药",nature:"凉",flavor:"甘、微苦",meridian:"心、肺、肾",effect:"补气养阴、清热生津",indication:"气虚阴亏、虚热烦倦、咳喘痰血、内热消渴、口燥咽干",formula:"清暑益气汤",fun:"西洋参与人参都能补气，但西洋参药性偏凉，兼能养阴清热；服用仍需根据体质和证候判断。"},
{id:183,name:"肉苁蓉",emoji:"\u{1F33F}",cat:"补益药",nature:"温",flavor:"甘、咸",meridian:"肾、大肠",effect:"补肾阳、益精血、润肠通便",indication:"肾阳不足、精血亏虚、阳痿不孕、腰膝酸软、筋骨无力、肠燥便秘",formula:"济川煎",fun:"肉苁蓉是寄生植物，有“沙漠人参”之称，既能温补肾阳，又因质地滋润而能润肠通便。"},
{id:184,name:"锁阳",emoji:"\u{1F33F}",cat:"补益药",nature:"温",flavor:"甘",meridian:"肝、肾、大肠",effect:"补肾阳、益精血、润肠通便",indication:"肾阳不足、精血亏虚、腰膝痿软、阳痿滑精、肠燥便秘",formula:"锁阳固精丸",fun:"锁阳生长于荒漠地区，是寄生性药用植物，功效与肉苁蓉相近，但传统上补肾固精特点较受重视。"},
{id:185,name:"益智仁",emoji:"\u{1FAD8}",cat:"补益药",nature:"温",flavor:"辛",meridian:"脾、肾",effect:"暖肾固精缩尿、温脾止泻摄唾",indication:"肾气不固、遗精滑精、遗尿尿频、脾胃虚寒、腹痛泄泻、口涎过多",formula:"缩泉丸",fun:"益智仁是姜科植物的成熟果实，气味芳香，既能温肾固涩，也能温脾止泻。"},
{id:186,name:"乌梅",emoji:"\u{1FAD2}",cat:"收涩药",nature:"平",flavor:"酸、涩",meridian:"肝、脾、肺、大肠",effect:"敛肺止咳、涩肠止泻、安蛔止痛、生津止渴、消疮毒",indication:"肺虚久咳、久泻久痢、蛔厥腹痛、虚热消渴、口干烦渴",formula:"乌梅丸",fun:"乌梅由未成熟的梅果经过加工制成，酸味明显；乌梅丸中的乌梅具有安蛔和缓急止痛等作用。"},
{id:187,name:"五倍子",emoji:"\u{1FAD0}",cat:"收涩药",nature:"寒",flavor:"酸、涩",meridian:"肺、大肠、肾",effect:"敛肺降火、涩肠止泻、敛汗止血、收湿敛疮、固精止遗",indication:"肺虚久咳、久泻久痢、自汗盗汗、遗精滑精、崩漏便血、湿疮肿毒",formula:"玉锁丹",fun:"五倍子不是植物果实，而是昆虫刺激盐肤木等植物后形成的虫瘿，富含鞣质，收涩作用较强。"},
{id:188,name:"诃子",emoji:"\u{1FAD0}",cat:"收涩药",nature:"平",flavor:"苦、酸、涩",meridian:"肺、大肠",effect:"涩肠止泻、敛肺止咳、利咽开音",indication:"久泻久痢、脱肛、肺虚久咳、久咳失音、咽喉不利",formula:"真人养脏汤",fun:"诃子以成熟果实入药，收涩作用较强；煨诃子偏于涩肠止泻，生诃子偏于敛肺利咽。"},
{id:189,name:"肉豆蔻",emoji:"\u{1FAD8}",cat:"收涩药",nature:"温",flavor:"辛",meridian:"脾、胃、大肠",effect:"涩肠止泻、温中行气",indication:"脾胃虚寒、久泻久痢、脘腹胀痛、食少呕吐",formula:"四神丸",fun:"肉豆蔻既是芳香辛温的药材，也是香辛料；入药常经煨制，以减轻油性并增强涩肠止泻作用。"},
{id:190,name:"赤石脂",emoji:"\u{1FAA8}",cat:"收涩药",nature:"温",flavor:"甘、酸、涩",meridian:"大肠、胃",effect:"涩肠止泻、收敛止血、敛疮生肌",indication:"久泻久痢、大便出血、崩漏带下、疮疡久溃不敛、湿疮流水",formula:"桃花汤",fun:"赤石脂属于矿物类药材，具有较强的吸附和收涩特点，传统上可内服涩肠，也可外用敛疮。"},
{id:191,name:"金樱子",emoji:"\u{1FAD2}",cat:"收涩药",nature:"平",flavor:"酸、甘、涩",meridian:"肾、膀胱、大肠",effect:"固精缩尿、固崩止带、涩肠止泻",indication:"遗精滑精、遗尿尿频、崩漏带下、久泻久痢",formula:"水陆二仙丹",fun:"金樱子是金樱子的成熟果实，表面具有刺状突起，传统上以固精、缩尿和涩肠见长。"},
{id:192,name:"桑螵蛸",emoji:"\u{1F41B}",cat:"收涩药",nature:"平",flavor:"甘、咸",meridian:"肝、肾",effect:"固精缩尿、补肾助阳",indication:"肾气不固、遗精滑精、遗尿尿频、小便白浊、肾虚阳痿",formula:"桑螵蛸散",fun:"桑螵蛸是螳螂的干燥卵鞘，属于动物类药材，传统上常用于肾气不固所致的遗尿和遗精。"},
{id:193,name:"海螵蛸",emoji:"\u{1F419}",cat:"收涩药",nature:"温",flavor:"咸、涩",meridian:"脾、肾",effect:"收敛止血、涩精止带、制酸止痛、收湿敛疮",indication:"吐血衄血、崩漏便血、遗精滑精、赤白带下、胃痛吞酸、湿疮湿疹、溃疡不敛",formula:"固冲汤",fun:"海螵蛸又称乌贼骨，是乌贼的内壳，质地轻而多孔，兼有收涩止血和制酸止痛作用。"},
{id:194,name:"芡实",emoji:"\u{1F331}",cat:"收涩药",nature:"平",flavor:"甘、涩",meridian:"脾、肾",effect:"益肾固精、补脾止泻、除湿止带",indication:"遗精滑精、遗尿尿频、脾虚久泻、白浊带下",formula:"金锁固精丸",fun:"芡实是芡的成熟种仁，俗称鸡头米，既是食材又可入药，特点是补而不峻、涩而不滞。"},
{id:195,name:"覆盆子",emoji:"\u{1FAD0}",cat:"收涩药",nature:"温",flavor:"甘、酸",meridian:"肝、肾、膀胱",effect:"益肾固精缩尿、养肝明目",indication:"肾虚遗精、滑精、遗尿尿频、阳痿早泄、肝肾不足、目暗昏花",formula:"五子衍宗丸",fun:"覆盆子是华东覆盆子的干燥果实，传统解释其名称有改善小便频数、使夜壶闲置之意。"},
{id:196,name:"朱砂",emoji:"\u{1F534}",cat:"安神药",nature:"微寒",flavor:"甘",meridian:"心",effect:"清心镇惊、安神、明目、解毒",indication:"心神不宁、心悸易惊、失眠多梦、惊风癫痫、视物昏花、口疮、咽喉肿痛",formula:"朱砂安神丸",fun:"朱砂是含硫化汞的矿物类药材，具有毒性，不可过量或长期使用，也不能自行服用或用火煅烧。"},
{id:197,name:"琥珀",emoji:"\u{1F7E0}",cat:"安神药",nature:"平",flavor:"甘",meridian:"心、肝、膀胱",effect:"镇惊安神、活血散瘀、利尿通淋",indication:"心神不宁、心悸失眠、惊风癫痫、血瘀经闭、癥瘕积聚、淋证尿痛",formula:"琥珀抱龙丸",fun:"琥珀是古代树脂形成的化石，质地较脆，传统使用多研末冲服，不宜放入汤剂长时间煎煮。"},
{id:198,name:"合欢皮",emoji:"\u{1F333}",cat:"安神药",nature:"平",flavor:"甘",meridian:"心、肝、肺",effect:"解郁安神、活血消肿",indication:"情志不遂、忧郁失眠、心神不宁、跌打损伤、骨折疼痛、肺痈疮肿",formula:"安神解郁汤",fun:"合欢树叶片昼开夜合，古人借其象征和合欢乐；合欢皮常用于情志不畅所致的失眠和烦闷。"},
{id:199,name:"夜交藤",emoji:"\u{1F33F}",cat:"安神药",nature:"平",flavor:"甘",meridian:"心、肝",effect:"养血安神、祛风通络",indication:"阴血不足、虚烦失眠、多梦、血虚身痛、风湿痹痛、皮肤瘙痒",formula:"天王补心丹加减",fun:"夜交藤又称首乌藤，是何首乌的藤茎，功效侧重于养血安神，与制何首乌的补益作用有所不同。"},
{id:200,name:"灵芝",emoji:"\u{1F344}",cat:"安神药",nature:"平",flavor:"甘",meridian:"心、肺、肝、肾",effect:"补气安神、止咳平喘",indication:"心神不宁、失眠心悸、肺虚咳喘、虚劳短气、不思饮食",formula:"灵芝饮",fun:"灵芝是一类药用真菌，古代常被视为吉祥长寿的象征；药用品种和质量应以规范标准鉴别。"},
{id:201,name:"牡蛎",emoji:"\u{1F41A}",cat:"平肝潜阳药",nature:"微寒",flavor:"咸",meridian:"肝、胆、肾",effect:"重镇安神、潜阳补阴、软坚散结、收敛固涩、制酸止痛",indication:"心神不安、惊悸失眠、肝阳上亢、头晕目眩、瘰疬痰核、自汗盗汗、遗精滑精、胃痛吞酸",formula:"桂枝甘草龙骨牡蛎汤",fun:"牡蛎是牡蛎的贝壳，质地坚硬，入汤剂通常打碎先煎；生牡蛎偏于潜阳软坚，煅牡蛎偏于收敛固涩。"},
{id:202,name:"磁石",emoji:"\u{1F9F2}",cat:"平肝潜阳药",nature:"寒",flavor:"咸",meridian:"心、肝、肾",effect:"镇惊安神、平肝潜阳、聪耳明目、纳气平喘",indication:"心神不宁、惊悸失眠、肝阳上亢、头晕目眩、耳鸣耳聋、视物昏花、肾虚气喘",formula:"磁朱丸",fun:"磁石是具有磁性的矿物类药材，质地坚硬，传统煎煮时通常打碎先煎，并应注意药材质量与重金属安全。"},
{id:203,name:"珍珠母",emoji:"\u{1F41A}",cat:"平肝潜阳药",nature:"寒",flavor:"咸",meridian:"肝、心",effect:"平肝潜阳、安神定惊、明目退翳",indication:"肝阳上亢、头痛眩晕、心神不宁、惊悸失眠、目赤翳障、视物昏花",formula:"珍珠母丸",fun:"珍珠母是珍珠贝等贝类的贝壳，质地坚硬，入汤剂通常打碎先煎，与珍珠并不是同一种药材。"},
{id:204,name:"石决明",emoji:"\u{1F41A}",cat:"平肝潜阳药",nature:"寒",flavor:"咸",meridian:"肝",effect:"平肝潜阳、清肝明目",indication:"肝阳上亢、头痛眩晕、目赤肿痛、羞明畏光、目生翳障、视物昏花",formula:"石决明散",fun:"石决明是鲍科动物的贝壳，因传统上善于清肝明目而得名，质地坚硬，入汤剂通常打碎先煎。"},
{id:205,name:"代赭石",emoji:"\u{1FAA8}",cat:"平肝潜阳药",nature:"寒",flavor:"苦",meridian:"肝、心、肺、胃",effect:"平肝潜阳、重镇降逆、凉血止血",indication:"肝阳上亢、头晕目眩、嗳气呃逆、呕吐噎膈、气逆喘息、血热吐衄、崩漏",formula:"旋覆代赭汤",fun:"代赭石是赤铁矿类矿物药，质地沉重，善于重镇降逆；入汤剂通常打碎先煎，并应注意规范的质量检测。"},
{id:206,name:"钩藤",emoji:"\u{1F33F}",cat:"息风止痉药",nature:"凉",flavor:"甘",meridian:"肝、心包",effect:"息风定惊、清热平肝",indication:"肝风内动、惊痫抽搐、高热惊厥、肝阳上亢、头痛眩晕",formula:"天麻钩藤饮",fun:"钩藤以带钩的茎枝入药，有效成分不耐久煎，传统汤剂中通常在其他药物煎好前短时间后下。"},
{id:207,name:"天麻",emoji:"\u{1F33F}",cat:"息风止痉药",nature:"平",flavor:"甘",meridian:"肝",effect:"息风止痉、平抑肝阳、祛风通络",indication:"肝风内动、惊痫抽搐、眩晕头痛、肢体麻木、手足不遂、风湿痹痛",formula:"天麻钩藤饮",fun:"天麻自身缺乏叶绿素，需要与特定真菌建立共生关系才能生长，是药用植物中典型的共生现象。"},
{id:208,name:"地龙",emoji:"\u{1FAB1}",cat:"息风止痉药",nature:"寒",flavor:"咸",meridian:"肝、脾、膀胱",effect:"清热定惊、通络、平喘、利尿",indication:"高热神昏、惊痫抽搐、关节痹痛、肢体麻木、半身不遂、肺热喘咳、小便不利",formula:"补阳还五汤",fun:"地龙是蚯蚓的干燥体，属于动物类药材，传统上用于热性痉挛、经络痹阻以及肺热喘咳等证候。"},
{id:209,name:"全蝎",emoji:"\u{1F982}",cat:"息风止痉药",nature:"平",flavor:"辛",meridian:"肝",effect:"息风镇痉、通络止痛、攻毒散结",indication:"痉挛抽搐、小儿惊风、中风口眼歪斜、半身不遂、偏正头痛、风湿顽痹、疮疡肿毒",formula:"牵正散",fun:"全蝎属于有毒动物类药材，药力较强，内服必须严格控制剂量，并由专业人员根据具体证候使用。"},
{id:210,name:"蜈蚣",emoji:"\u{1FAB1}",cat:"息风止痉药",nature:"温",flavor:"辛",meridian:"肝",effect:"息风镇痉、通络止痛、攻毒散结",indication:"痉挛抽搐、小儿惊风、中风口眼歪斜、顽固性头痛、风湿痹痛、疮疡肿毒、瘰疬结核",formula:"止痉散",fun:"蜈蚣属于有毒动物类药材，传统上用于顽固性痉挛和经络疼痛，必须规范处理并由专业人员使用。"},
{id:211,name:"僵蚕",emoji:"\u{1F41B}",cat:"息风止痉药",nature:"平",flavor:"咸、辛",meridian:"肝、肺、胃",effect:"息风止痉、祛风止痛、化痰散结",indication:"惊痫抽搐、中风口眼歪斜、风热头痛、目赤咽痛、风疹瘙痒、痰核瘰疬",formula:"牵正散",fun:"僵蚕是家蚕感染特定真菌后形成的干燥体，属于动物类药材，具有息风、祛风和化痰散结等特点。"},
{id:212,name:"蒺藜",emoji:"\u{1F33F}",cat:"平肝潜阳药",nature:"微温",flavor:"辛、苦",meridian:"肝",effect:"平肝解郁、活血祛风、明目止痒",indication:"肝阳上亢、头痛眩晕、胸胁胀痛、乳闭乳痈、目赤翳障、风疹瘙痒",formula:"白蒺藜散",fun:"蒺藜果实具有坚硬的刺，传统上既用于肝阳上亢，也用于肝郁气滞以及风邪所致的皮肤瘙痒。"},
{id:213,name:"苏合香",emoji:"\u{1FAD9}",cat:"开窍药",nature:"温",flavor:"辛",meridian:"心、脾",effect:"开窍醒神、辟秽止痛",indication:"寒闭神昏、中风痰厥、惊痫、胸腹冷痛、满闷不适",formula:"苏合香丸",fun:"苏合香是一种芳香树脂类药材，气味浓烈，传统上多入丸散剂使用，通常不放入汤剂中长时间煎煮。"},
{id:214,name:"石菖蒲",emoji:"\u{1F33F}",cat:"开窍药",nature:"温",flavor:"辛、苦",meridian:"心、胃",effect:"开窍豁痰、醒神益智、化湿开胃",indication:"痰蒙清窍、神昏癫痫、健忘失眠、耳鸣耳聋、湿阻中焦、脘痞不饥",formula:"安神定志丸",fun:"石菖蒲气味芳香，传统上常用于痰湿蒙蔽清窍以及湿浊困脾等证候，应用需要注意规范品种和剂量。"},
{id:215,name:"冰片",emoji:"\u{2744}",cat:"开窍药",nature:"微寒",flavor:"辛、苦",meridian:"心、脾、肺",effect:"开窍醒神、清热止痛",indication:"热闭神昏、中风痰厥、惊痫、胸痹心痛、目赤、咽喉肿痛、口舌生疮、疮疡肿痛",formula:"安宫牛黄丸",fun:"冰片气味芳香而易挥发，传统上多入丸散剂或外用，一般不与其他药物一起长时间煎煮。"},
{id:216,name:"牛黄",emoji:"\u{1F7E1}",cat:"开窍药",nature:"凉",flavor:"甘",meridian:"心、肝",effect:"化痰开窍、凉肝息风、清热解毒",indication:"热病神昏、中风痰迷、惊痫抽搐、咽喉肿痛、口舌生疮、痈肿疔毒",formula:"安宫牛黄丸",fun:"天然牛黄来源稀少，现代药品中也会依法使用人工牛黄或培植牛黄；不同品种不能随意替换，需遵循药品标准。"},
{id:217,name:"郁金",emoji:"\u{1F33F}",cat:"活血化瘀药",nature:"寒",flavor:"辛、苦",meridian:"肝、心、肺",effect:"活血止痛、行气解郁、清心凉血、利胆退黄",indication:"胸胁刺痛、胸痹心痛、经闭痛经、癥瘕痞块、热病神昏、吐血衄血、湿热黄疸",formula:"白金丸",fun:"郁金既能活血行气，又能清心凉血、利胆退黄；传统配伍理论中一般不与丁香同用。"},
{id:218,name:"延胡索",emoji:"\u{1F33F}",cat:"活血化瘀药",nature:"温",flavor:"辛、苦",meridian:"肝、脾",effect:"活血、行气、止痛",indication:"胸胁脘腹疼痛、经闭痛经、产后瘀阻、跌打损伤、疝气疼痛",formula:"金铃子散",fun:"延胡索又称元胡，既入血分又入气分，传统上广泛用于气滞血瘀所致的多种疼痛。"},
{id:219,name:"乳香",emoji:"\u{1FAD9}",cat:"活血化瘀药",nature:"温",flavor:"辛、苦",meridian:"心、肝、脾",effect:"活血定痛、消肿生肌",indication:"胸痹心痛、脘腹疼痛、痛经经闭、产后瘀阻、跌打损伤、风湿痹痛、疮疡肿痛",formula:"七厘散",fun:"乳香是乳香树等植物渗出的树脂，气味芳香，常与没药配伍，用于瘀血疼痛和疮疡肿痛。"},
{id:220,name:"没药",emoji:"\u{1FAD9}",cat:"活血化瘀药",nature:"平",flavor:"辛、苦",meridian:"心、肝、脾",effect:"散瘀定痛、消肿生肌",indication:"胸痹心痛、脘腹疼痛、痛经经闭、产后瘀阻、跌打损伤、痈肿疮疡",formula:"七厘散",fun:"没药是一种树脂类药材，常与乳香配伍；乳香偏于行气伸筋，没药偏于散血化瘀，但两者功效相近。"},
{id:221,name:"五灵脂",emoji:"\u{1F43F}",cat:"活血化瘀药",nature:"温",flavor:"苦、甘",meridian:"肝",effect:"活血止痛、化瘀止血",indication:"胸胁脘腹刺痛、痛经经闭、产后瘀阻、跌打损伤、瘀血出血",formula:"失笑散",fun:"五灵脂是鼯鼠类动物的干燥粪便，传统上用于瘀血疼痛；用药时需经过规范处理，并注意与人参的传统配伍禁忌。"},
{id:222,name:"鸡血藤",emoji:"\u{1F33F}",cat:"活血化瘀药",nature:"温",flavor:"苦、甘",meridian:"肝、肾",effect:"行血补血、调经、舒筋活络",indication:"月经不调、痛经经闭、血虚萎黄、肢体麻木、风湿痹痛、中风不遂",formula:"鸡血藤汤",fun:"鸡血藤藤茎切开后可见红褐色汁液或纹理，传统上认为其兼有活血与补血作用。"},
{id:223,name:"王不留行",emoji:"\u{1F331}",cat:"活血化瘀药",nature:"平",flavor:"苦",meridian:"肝、胃",effect:"活血通经、下乳、消肿、利尿通淋",indication:"经闭痛经、乳汁不下、乳痈肿痛、淋证涩痛、小便不利",formula:"下乳涌泉散",fun:"王不留行的名称体现其走而不守的作用特点，传统上常用于血脉不通、乳汁不下及淋证。"},
{id:224,name:"三棱",emoji:"\u{1F33F}",cat:"活血化瘀药",nature:"平",flavor:"辛、苦",meridian:"肝、脾",effect:"破血行气、消积止痛",indication:"癥瘕痞块、瘀血经闭、食积气滞、脘腹胀痛",formula:"三棱丸",fun:"三棱破血行气之力较强，常与莪术配伍用于瘀血与食积互结之证；孕期及出血倾向者不可自行使用。"},
{id:225,name:"莪术",emoji:"\u{1F33F}",cat:"活血化瘀药",nature:"温",flavor:"辛、苦",meridian:"肝、脾",effect:"破血行气、消积止痛",indication:"癥瘕痞块、瘀血经闭、胸痹心痛、食积气滞、脘腹胀痛",formula:"三棱丸",fun:"莪术与三棱常相须配伍，破血消积作用较强；本品不适合孕期或有出血风险者自行使用。"},
{id:226,name:"仙鹤草",emoji:"\u{1F33F}",cat:"止血药",nature:"平",flavor:"苦、涩",meridian:"心、肝",effect:"收敛止血、截疟、止痢、解毒、补虚",indication:"咯血吐血、衄血、尿血、便血、崩漏、疟疾寒热、血痢脱力劳伤",formula:"仙鹤草汤",fun:"仙鹤草又称脱力草，既能用于多种出血证，也有补虚强壮的传统应用，药性较为平和。"},
{id:227,name:"白茅根",emoji:"\u{1F33E}",cat:"止血药",nature:"寒",flavor:"甘",meridian:"肺、胃、膀胱",effect:"凉血止血、清热利尿、清肺胃热",indication:"血热吐血、衄血、咯血、尿血、热病烦渴、胃热呕吐、肺热咳嗽、湿热黄疸、水肿尿少",formula:"十灰散",fun:"白茅根是白茅的地下根茎，鲜品含水丰富，传统上常用于血热出血和热淋尿血。"},
{id:228,name:"茜草",emoji:"\u{1F33F}",cat:"止血药",nature:"寒",flavor:"苦",meridian:"肝",effect:"凉血、祛瘀、止血、通经",indication:"吐血衄血、崩漏下血、外伤出血、血瘀经闭、跌打损伤、风湿痹痛",formula:"固经丸",fun:"茜草的根含有红色色素，古代曾用于染色；药用时兼具凉血止血和祛瘀通经作用。"},
{id:229,name:"棕榈炭",emoji:"\u{1F334}",cat:"止血药",nature:"平",flavor:"苦、涩",meridian:"肺、肝、大肠",effect:"收敛止血",indication:"吐血、衄血、尿血、便血、崩漏、月经过多及其他出血证",formula:"十灰散",fun:"棕榈炭由棕榈的叶柄纤维经过规范炭化制成，收涩止血作用较强，常用于出血不止之证。"},
{id:230,name:"血余炭",emoji:"\u{1F525}",cat:"止血药",nature:"平",flavor:"苦",meridian:"肝、胃",effect:"收敛止血、化瘀利尿",indication:"吐血衄血、咯血、尿血、便血、崩漏、外伤出血、小便不利",formula:"十灰散",fun:"血余炭由人的头发经过规范炭化加工制成，传统理论认为“发为血之余”，故名血余炭。"},
{id:231,name:"炮姜",emoji:"\u{1FADA}",cat:"止血药",nature:"温",flavor:"辛",meridian:"脾、胃、肾",effect:"温经止血、温中止痛",indication:"脾胃虚寒、吐血便血、崩漏下血、阳虚失血、腹痛泄泻",formula:"黄土汤",fun:"炮姜由干姜经过炮制而成，与生姜、干姜的作用侧重不同，炮姜主要用于虚寒性出血和中焦寒证。"},
{id:232,name:"使君子",emoji:"\u{1FAD0}",cat:"驱虫药",nature:"温",flavor:"甘",meridian:"脾、胃",effect:"杀虫消积",indication:"蛔虫病、蛲虫病、虫积腹痛、小儿疳积、面黄肌瘦、食欲不振",formula:"使君子丸",fun:"使君子味甘，传统上较常用于小儿虫积；大量服用可能引起呃逆、眩晕或呕吐，不宜自行超量使用。"},
{id:233,name:"苦楝皮",emoji:"\u{1F333}",cat:"驱虫药",nature:"寒",flavor:"苦",meridian:"肝、脾、胃",effect:"杀虫、疗癣",indication:"蛔虫病、蛲虫病、虫积腹痛、头癣、疥癣、皮肤瘙痒",formula:"苦楝皮汤",fun:"苦楝皮具有毒性，使用剂量和疗程需要严格控制，肝功能异常者及孕期人群不可自行使用。"},
{id:234,name:"雷丸",emoji:"\u{1F344}",cat:"驱虫药",nature:"寒",flavor:"微苦",meridian:"胃、大肠",effect:"杀虫消积",indication:"绦虫病、钩虫病、蛔虫病、脑囊虫病、虫积腹痛、小儿疳积",formula:"雷丸散",fun:"雷丸是一种药用真菌，其有效成分不耐高温，传统上多研粉服用而不入汤剂久煎，具体使用必须遵循专业指导。"},
{id:235,name:"鹤草芽",emoji:"\u{1F331}",cat:"驱虫药",nature:"凉",flavor:"苦、涩",meridian:"肝、小肠、大肠",effect:"杀虫",indication:"绦虫病及虫积腹痛",formula:"鹤草芽散",fun:"鹤草芽是龙芽草的冬芽，传统上主要用于绦虫病，通常研粉使用，不宜放入汤剂中长时间煎煮。"},
{id:236,name:"南瓜子",emoji:"\u{1F383}",cat:"驱虫药",nature:"平",flavor:"甘",meridian:"胃、大肠",effect:"杀虫",indication:"绦虫病、血吸虫病及虫积腹痛",formula:"南瓜子槟榔汤",fun:"南瓜子既是食物，也是传统驱虫药，常与槟榔配伍用于绦虫病，但现实治疗应遵循规范医疗方案。"},
{id:237,name:"川乌",emoji:"\u{1F33F}",cat:"祛风湿药",nature:"热",flavor:"辛、苦",meridian:"心、肝、肾、脾",effect:"祛风除湿、温经止痛",indication:"风寒湿痹、关节剧痛、心腹冷痛、寒疝疼痛、跌打损伤、麻醉止痛",formula:"乌头汤",fun:"川乌具有强烈毒性，生品禁止自行内服，必须使用规范炮制品并严格控制剂量和煎煮时间；误用可引起严重心律失常。"},
{id:238,name:"蕲蛇",emoji:"\u{1F40D}",cat:"祛风湿药",nature:"温",flavor:"甘、咸",meridian:"肝",effect:"祛风、通络、止痉",indication:"风湿顽痹、麻木拘挛、中风口眼歪斜、半身不遂、抽搐痉挛、麻风疥癣",formula:"小活络丹",fun:"蕲蛇属于动物类药材，传统上以祛风通络力量较强著称，药材来源应符合野生动物保护及药品管理规定。"},
{id:239,name:"乌梢蛇",emoji:"\u{1F40D}",cat:"祛风湿药",nature:"平",flavor:"甘",meridian:"肝",effect:"祛风、通络、止痉",indication:"风湿顽痹、麻木拘挛、中风口眼歪斜、半身不遂、惊风抽搐、破伤风、麻风疥癣",formula:"乌蛇止痒丸",fun:"乌梢蛇属于动物类药材，药性相对平和，传统上用于风邪偏盛的痹痛、麻木和皮肤瘙痒等证候。"},
{id:240,name:"防己",emoji:"\u{1F33F}",cat:"祛风湿药",nature:"寒",flavor:"苦",meridian:"膀胱、肺",effect:"祛风止痛、利水消肿",indication:"风湿痹痛、水肿、小便不利、脚气肿痛、湿疹疮毒",formula:"防己黄芪汤",fun:"药用防己通常指粉防己，必须与含马兜铃酸的广防己等混淆品种严格区分，以避免严重的肾脏损害。"},
{id:241,name:"豨莶草",emoji:"\u{1F33F}",cat:"祛风湿药",nature:"寒",flavor:"辛、苦",meridian:"肝、肾",effect:"祛风湿、利关节、解毒",indication:"风湿痹痛、筋骨无力、腰膝酸软、半身不遂、风疹湿疮、痈肿疮毒",formula:"豨莶丸",fun:"豨莶草生用偏于祛风湿和解毒，酒制后传统上更偏于补益肝肾、强健筋骨。"},
{id:242,name:"络石藤",emoji:"\u{1F33F}",cat:"祛风湿药",nature:"微寒",flavor:"苦",meridian:"心、肝、肾",effect:"祛风通络、凉血消肿",indication:"风湿热痹、筋脉拘挛、腰膝酸痛、喉痹、痈肿、跌打损伤",formula:"络石藤汤",fun:"络石藤是络石的带叶藤茎，善于治疗偏热性的风湿痹痛，并有凉血消肿的传统作用。"},
{id:243,name:"桑枝",emoji:"\u{1F333}",cat:"祛风湿药",nature:"平",flavor:"微苦",meridian:"肝",effect:"祛风湿、利关节",indication:"风湿痹痛、肩臂关节酸痛麻木、四肢拘挛、水肿、脚气",formula:"桑枝汤",fun:"桑枝是桑树的嫩枝，作用偏于上肢和肩臂，常用于风湿所致的关节疼痛和屈伸不利。"},
{id:244,name:"海风藤",emoji:"\u{1F33F}",cat:"祛风湿药",nature:"微温",flavor:"辛、苦",meridian:"肝",effect:"祛风湿、通经络、止痹痛",indication:"风寒湿痹、肢节疼痛、筋脉拘挛、屈伸不利、跌打损伤",formula:"海风藤汤",fun:"海风藤以藤茎入药，具有走窜通络特点，传统上常用于风寒湿邪阻滞经络所致的肢节疼痛。"},
{id:245,name:"雷公藤",emoji:"\u{26A0}",cat:"祛风湿药",nature:"凉",flavor:"苦、辛",meridian:"肝、肾",effect:"祛风除湿、活血通络、消肿止痛、杀虫解毒",indication:"风湿顽痹、关节肿痛、麻风、顽癣、疥疮、皮肤瘙痒",formula:"雷公藤制剂",fun:"雷公藤具有明显毒性，可能损害肝肾、血液及生殖系统，必须使用正规制剂并由专业人员监测，严禁自行煎服。"},
{id:246,name:"萆薢",emoji:"\u{1F33F}",cat:"祛湿药",nature:"平",flavor:"苦",meridian:"肾、胃",effect:"利湿去浊、祛风除痹",indication:"膏淋白浊、带下过多、风湿痹痛、腰膝疼痛、关节屈伸不利",formula:"萆薢分清饮",fun:"萆薢以利湿分清去浊见长，是治疗膏淋白浊的代表药材之一，同时兼能祛风除痹。"},
{id:247,name:"瞿麦",emoji:"\u{1F33A}",cat:"祛湿药",nature:"寒",flavor:"苦",meridian:"心、小肠",effect:"利尿通淋、活血通经",indication:"热淋、血淋、石淋、小便不通、淋沥涩痛、经闭瘀阻",formula:"八正散",fun:"瞿麦既能清热利尿通淋，又能活血通经；孕期不宜自行使用。"},
{id:248,name:"萹蓄",emoji:"\u{1F33F}",cat:"祛湿药",nature:"微寒",flavor:"苦",meridian:"膀胱",effect:"利尿通淋、杀虫止痒",indication:"热淋涩痛、小便短赤、石淋、虫积腹痛、湿疹、阴痒、带下",formula:"八正散",fun:"萹蓄常与瞿麦、木通等配伍治疗湿热淋证，外用还有杀虫止痒的传统应用。"},
{id:249,name:"地肤子",emoji:"\u{1F331}",cat:"祛湿药",nature:"寒",flavor:"辛、苦",meridian:"肾、膀胱",effect:"清热利湿、祛风止痒",indication:"小便涩痛、阴痒带下、风疹、湿疹、皮肤瘙痒",formula:"地肤子汤",fun:"地肤子是地肤的成熟果实，地肤植株干枯后可随风滚动，因此也有扫帚菜等俗称。"},
{id:250,name:"冬瓜皮",emoji:"\u{1F96C}",cat:"祛湿药",nature:"凉",flavor:"甘",meridian:"脾、小肠",effect:"利尿消肿、清热解暑",indication:"水肿胀满、小便不利、暑热口渴、短气烦闷、痈肿",formula:"五皮饮",fun:"冬瓜皮来自冬瓜的外层果皮，药性轻缓，是常见的药食来源利水消肿药材。"},
{id:251,name:"泽兰",emoji:"\u{1F33F}",cat:"活血化瘀药",nature:"微温",flavor:"苦、辛",meridian:"肝、脾",effect:"活血调经、祛瘀消痈、利水消肿",indication:"血瘀经闭、月经不调、痛经、产后瘀滞腹痛、跌打损伤、痈肿疮毒、水肿腹水",formula:"泽兰汤",fun:"泽兰既能活血祛瘀，又能利水消肿，传统上常用于妇科瘀血证以及瘀血兼水肿之证。"},
{id:252,name:"月季花",emoji:"\u{1F339}",cat:"活血化瘀药",nature:"温",flavor:"甘",meridian:"肝",effect:"活血调经、疏肝解郁",indication:"气滞血瘀、月经不调、痛经、经闭、胸腹胀痛、情志抑郁",formula:"月季花汤",fun:"月季花因一年中可多次开花而得名，药性较为平和，传统上常用于肝郁血滞所致的月经不调。"},
{id:253,name:"凌霄花",emoji:"\u{1F33A}",cat:"活血化瘀药",nature:"微寒",flavor:"甘、酸",meridian:"肝、心包",effect:"活血通经、凉血祛风",indication:"血瘀经闭、癥瘕积聚、产后乳肿、风疹发红、皮肤瘙痒、痤疮",formula:"凌霄花散",fun:"凌霄花是攀援植物凌霄的花，既能活血通经，又能凉血祛风；孕期不宜自行使用。"},
{id:254,name:"土鳖虫",emoji:"\u{1FAB3}",cat:"活血化瘀药",nature:"寒",flavor:"咸",meridian:"肝",effect:"破血逐瘀、续筋接骨",indication:"筋骨折伤、瘀血肿痛、血瘀经闭、产后瘀滞腹痛、癥瘕痞块",formula:"大黄䗪虫丸",fun:"土鳖虫又称䗪虫，属于动物类药材，破血逐瘀作用较强；孕期及有出血风险者不可自行使用。"},
{id:255,name:"水蛭",emoji:"\u{1FAB1}",cat:"活血化瘀药",nature:"平",flavor:"咸、苦",meridian:"肝",effect:"破血通经、逐瘀消癥",indication:"血瘀经闭、癥瘕痞块、中风偏瘫、跌打损伤、瘀血疼痛",formula:"抵当汤",fun:"水蛭属于动物类破血药，药力较强并可能增加出血风险，必须经过规范处理并由专业人员辨证使用。"},
{id:256,name:"虻虫",emoji:"\u{1FAB0}",cat:"活血化瘀药",nature:"微寒",flavor:"苦",meridian:"肝",effect:"破血逐瘀、消癥散积",indication:"血瘀经闭、产后恶露不尽、少腹蓄血、癥瘕痞块、跌打损伤",formula:"抵当汤",fun:"虻虫是虻科昆虫的干燥雌虫，破血逐瘀作用峻猛，孕期、月经过多及有出血倾向者不可自行使用。"},
{id:257,name:"苏木",emoji:"\u{1FAB5}",cat:"活血化瘀药",nature:"平",flavor:"甘、咸",meridian:"心、肝、脾",effect:"活血祛瘀、消肿止痛",indication:"跌打损伤、骨折筋伤、瘀血肿痛、血滞经闭、痛经、产后瘀阻腹痛",formula:"八厘散",fun:"苏木的心材入药，煎煮后汤液常呈红色，古代还曾作为红色染料使用。"},
{id:258,name:"自然铜",emoji:"\u{1FAA8}",cat:"活血化瘀药",nature:"平",flavor:"辛",meridian:"肝",effect:"散瘀止痛、接骨疗伤",indication:"跌打损伤、筋骨折伤、瘀血肿痛",formula:"接骨紫金丹",fun:"自然铜是矿物类药材，传统上以散瘀止痛和接骨疗伤见长，使用时应经过规范炮制并注意重金属与杂质检测。"},
{id:259,name:"骨碎补",emoji:"\u{1F33F}",cat:"活血化瘀药",nature:"温",flavor:"苦",meridian:"肝、肾",effect:"活血续伤、补肾强骨",indication:"跌打损伤、筋骨折伤、瘀肿疼痛、肾虚腰痛、筋骨痿软、牙齿松动、耳鸣耳聋",formula:"骨碎补丸",fun:"骨碎补因传统上常用于筋骨损伤而得名，既能活血疗伤，又能补肾强骨。"},
{id:260,name:"血竭",emoji:"\u{1F534}",cat:"活血化瘀药",nature:"平",flavor:"甘、咸",meridian:"肝",effect:"活血定痛、化瘀止血、生肌敛疮",indication:"跌打损伤、瘀血疼痛、外伤出血、疮疡久溃不敛",formula:"七厘散",fun:"血竭是部分棕榈科植物果实渗出的红色树脂，传统上多研末使用，具有活血与止血并用的特点。"},
{id:261,name:"儿茶",emoji:"\u{1F7E4}",cat:"活血化瘀药",nature:"微寒",flavor:"苦、涩",meridian:"心、肺",effect:"活血止痛、止血生肌、收湿敛疮、清肺化痰",indication:"跌打伤痛、外伤出血、疮疡不敛、湿疹流水、口疮、肺热咳嗽",formula:"七厘散",fun:"儿茶是植物枝干煎液浓缩后的干燥物，收涩作用较强，传统上常用于外伤出血和疮面久不收口。"},
{id:262,name:"刘寄奴",emoji:"\u{1F33F}",cat:"活血化瘀药",nature:"温",flavor:"苦",meridian:"心、肝、脾",effect:"散瘀止痛、疗伤止血、破血通经、消食化积",indication:"跌打损伤、瘀血肿痛、外伤出血、血瘀经闭、产后腹痛、食积腹胀",formula:"刘寄奴散",fun:"刘寄奴既能活血疗伤，又能消食化积，名称来源有多种历史传说，但与南朝刘裕相关的说法流传较广。"},
{id:263,name:"马钱子",emoji:"\u{26A0}",cat:"活血化瘀药",nature:"温",flavor:"苦",meridian:"肝、脾",effect:"通络止痛、散结消肿",indication:"跌打损伤、骨折肿痛、风湿顽痹、肢体麻木、瘫痪、痈疽肿痛、咽喉肿痛",formula:"九分散",fun:"马钱子具有大毒，安全剂量范围很窄，误用可引起强直性惊厥甚至危及生命，只能使用规范炮制品并由专业人员严格管理。"},
{id:264,name:"旋覆花",emoji:"\u{1F33C}",cat:"化痰药",nature:"微温",flavor:"苦、辛、咸",meridian:"肺、脾、胃、大肠",effect:"降气消痰、行水止呕",indication:"咳嗽痰多、胸膈痞满、喘息气逆、痰饮蓄结、呕吐噫气",formula:"旋覆代赭汤",fun:"旋覆花表面有细小茸毛，可能刺激咽喉，传统入汤剂时通常用布袋包煎。"},
{id:265,name:"白芥子",emoji:"\u{1F331}",cat:"化痰药",nature:"温",flavor:"辛",meridian:"肺",effect:"温肺化痰、利气散结、通络止痛",indication:"寒痰喘咳、胸胁胀痛、痰滞经络、关节麻木疼痛、阴疽流注、肢体肿痛",formula:"三子养亲汤",fun:"白芥子辛温走散，善于温化寒痰和通络散结；外用时间过长可能引起皮肤红肿或起泡。"},
{id:266,name:"皂荚",emoji:"\u{1FAD8}",cat:"化痰药",nature:"温",flavor:"辛、咸",meridian:"肺、大肠",effect:"祛顽痰、通窍开闭、祛风杀虫",indication:"顽痰阻肺、咳喘痰多、中风口噤、神昏不开、癫痫痰盛、便秘、疥癣",formula:"皂荚丸",fun:"皂荚具有小毒且刺激性较强，祛痰力量峻猛，不适合体虚、孕期或有出血倾向者自行使用。"},
{id:267,name:"胖大海",emoji:"\u{1FAD8}",cat:"止咳药",nature:"寒",flavor:"甘",meridian:"肺、大肠",effect:"清热润肺、利咽开音、润肠通便",indication:"肺热声哑、咽喉肿痛、咳嗽痰黄、燥热便秘、头痛目赤",formula:"胖大海茶",fun:"胖大海遇水后会迅速膨胀，适合肺热咽痛和声音嘶哑等证候，但不宜作为日常保健茶长期大量饮用。"},
{id:268,name:"罗汉果",emoji:"\u{1F34F}",cat:"止咳药",nature:"凉",flavor:"甘",meridian:"肺、大肠",effect:"清热润肺、利咽开音、滑肠通便",indication:"肺热燥咳、咽痛失音、肠燥便秘",formula:"罗汉果饮",fun:"罗汉果味道甘甜，是常见的药食两用材料，其甜味成分并非普通蔗糖，但具体食用仍需结合个人情况。"},
{id:269,name:"洋金花",emoji:"\u{1F33A}",cat:"止咳药",nature:"温",flavor:"辛",meridian:"肺、肝",effect:"平喘止咳、解痉定痛、麻醉止痛",indication:"哮喘咳嗽、脘腹冷痛、风湿痹痛、癫痫惊风、外科麻醉",formula:"洋金花散",fun:"洋金花具有毒性，含莨菪烷类生物碱，误用可引起口干、幻觉、心跳加快甚至昏迷，严禁自行泡酒、泡茶或服用。"},
{id:270,name:"礞石",emoji:"\u{1FAA8}",cat:"化痰药",nature:"平",flavor:"甘、咸",meridian:"肺、肝",effect:"坠痰下气、平肝镇惊",indication:"顽痰胶结、咳喘痰多、癫痫发狂、烦躁胸闷、惊风抽搐",formula:"礞石滚痰丸",fun:"礞石属于矿物类药材，坠痰力量较强，通常需要经过煅制等规范炮制，不适合体虚者或孕期人群自行使用。"},
{id:271,name:"海藻",emoji:"\u{1F30A}",cat:"化痰药",nature:"寒",flavor:"苦、咸",meridian:"肝、胃、肾",effect:"消痰软坚散结、利水消肿",indication:"瘿瘤、瘰疬、睾丸肿痛、痰饮水肿、脚气浮肿",formula:"海藻玉壶汤",fun:"海藻是海洋藻类药材，传统配伍理论中有海藻与甘草不宜同用的记载，临床应用应由专业人员辨证判断。"},
{id:272,name:"昆布",emoji:"\u{1F30A}",cat:"化痰药",nature:"寒",flavor:"咸",meridian:"肝、胃、肾",effect:"消痰软坚散结、利水消肿",indication:"瘿瘤、瘰疬、睾丸肿痛、痰饮水肿、脚气浮肿",formula:"海藻玉壶汤",fun:"昆布来源于海带或昆布等海藻，含有较多碘等成分，甲状腺疾病患者不应据此自行大量食用或用药。"},
{id:273,name:"黄药子",emoji:"\u{1F33F}",cat:"化痰药",nature:"凉",flavor:"苦",meridian:"肺、肝",effect:"化痰散结消瘿、清热解毒",indication:"瘿瘤、瘰疬、咽喉肿痛、疮疡肿毒、蛇虫咬伤",formula:"消瘿汤",fun:"黄药子可能引起肝损伤，使用时需要严格控制剂量和疗程，并监测肝功能，不可自行长期煎服。"},
{id:274,name:"瓦楞子",emoji:"\u{1F41A}",cat:"化痰药",nature:"平",flavor:"咸",meridian:"肺、胃、肝",effect:"消痰化瘀、软坚散结、制酸止痛",indication:"顽痰积结、瘿瘤瘰疬、癥瘕痞块、胃痛泛酸、嗳气烧心",formula:"瓦楞子散",fun:"瓦楞子是蚶科贝类的贝壳，表面具有瓦楞状放射肋，质地坚硬，传统入汤剂时通常打碎先煎。"},
{id:275,name:"海蛤壳",emoji:"\u{1F41A}",cat:"化痰药",nature:"寒",flavor:"苦、咸",meridian:"肺、肾、胃",effect:"清肺化痰、软坚散结、利尿消肿、制酸止痛",indication:"痰热咳嗽、胸胁疼痛、瘿瘤瘰疬、水肿、小便不利、胃痛泛酸",formula:"海蛤散",fun:"海蛤壳属于贝壳类药材，质地坚硬，传统煎煮时通常打碎先煎；用药时应注意来源鉴别和重金属等质量检测。"}
